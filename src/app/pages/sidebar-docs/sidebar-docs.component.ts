...
//     // Écoute les événements de navigation et remet le scroll en haut de la page
//     this.router.events
//       .pipe(filter((event) => event instanceof NavigationEnd))
//       .subscribe(() => {
//         this.viewportScroller.scrollToPosition([0, 0]); // Remet la position de défilement en haut de la page
//       });
//   }
...
//   navigateTo(route: string) {
//     this.activeRoute = route;
//     this.router.navigate(['/docs', route], { fragment: 'top' }); 
//   }
